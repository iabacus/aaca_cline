		...
		<div>
			...
			<Section>
				<div className="flex px-4 flex-col gap-2">
					<h2 className="text-lg font-semibold">AACA Cline v{version}</h2>

					<p>{t("aboutSection.descCline")}</p>
					...
					<p>
						<VSCodeLink href="http://www.iabacus.co.kr">애버커스</VSCodeLink>
						{/* {" • "}
					...
					<h3 className="text-md font-semibold">Cline 사이트</h3>
					<p>
						<VSCodeLink href="https://docs.cline.bot/">Cline Documentation</VSCodeLink>
						{" • "}
						<VSCodeLink href="https://cline.bot/">Cline</VSCodeLink>
					</p>
				</div>
			</Section>
		</div>

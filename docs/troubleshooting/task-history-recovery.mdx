...
<Steps>
	<Step title="Locate and copy your Cline data">
		On your **old machine**, find the `iabacusai.aaca-cline-dev` folder using the [storage paths above](#storage-paths) and copy the entire folder.
	</Step>
	...
	<Step title="Transfer your data">
		Paste the `iabacusai.aaca-cline-dev` folder to the same storage path on your new machine.
	</Step>

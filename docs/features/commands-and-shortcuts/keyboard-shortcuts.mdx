...
| `aaca-cline-dev.SidebarProvider.focus` | Open Cline sidebar | `Ctrl+Shift+L` / `Cmd+Shift+L` |

**Note:** `aaca-cline-dev` prefix is for historical reasons - it works with Cline.
